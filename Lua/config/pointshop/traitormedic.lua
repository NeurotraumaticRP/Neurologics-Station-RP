...
category.CanAccess = function(client)
    return client.Character and not client.Character.IsDead and client.Character.HasJob("doctor") and Neurologics.RoleManager.HasRole(client.Character, "EvilDoctor")
end
...
category.Products = {
    {
        Identifier = "InstaPropofolTalent",
        Price = 1000,
        Limit = 1,
        IsLimitGlobal = false,
        Action = function (client)
            client.Character.Info.GiveTalent("ntsp_properfol")
        end
    },
...

    {
        ...
        Limit = 1,
        IsLimitGlobal = false,
        Items = {"frogsburstsyringegun", "chloralhydrate", "chloralhydrate", "chloralhydrate"},
    },
