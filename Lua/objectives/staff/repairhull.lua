...
function objective:Start(target)
    ...
    self.Text = string.format(Neurologics.Language.ObjectiveRepairHull, self.Progress, self.Amount, self.MinCondition)
...
function objective:HullRepaired(character, amount)
    ...
    self.Text = string.format(Neurologics.Language.ObjectiveRepairHull, math.floor(self.Progress), self.Amount, self.MinCondition)
end
